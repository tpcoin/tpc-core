...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start TPC after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start TPC on system login", 0));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintEnable->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic minting of TPC units to zTPC", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        percentage_label->setToolTip(QApplication::translate("OptionsDialog", "Percentage of incoming TPC which get automatically converted to zTPC via Zerocoin Protocol (min: 10%)", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the TPC client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the TPC network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting TPC.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/Harcomia-TPC/tpc-core-translations", 0));
