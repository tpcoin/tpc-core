...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to TPC Core.", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where TPC Core will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "TPC Core will download and store a copy of the TPC block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
