...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (tpc.conf).");
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#d8b36d;}\n a, span { font-family: monospace; }\n span.addr {color:#d8b36d; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #d8b36d;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#d8b36d;}\n a { color:#fff; text-decoration:none; }\n a.nav {color:#d8b36d;}\n";
